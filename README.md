...
> **নাম নিয়ে নোট:** "Scanvexa" — এই নামটা Play Store বা App Store-এ কোনো অ্যাপের নেই (যাচাই করা হয়েছে), এবং "CamScanner"-এর সাথে বানান, উচ্চারণ বা গঠনে কোনো মিল নেই — যাতে ইউজার ভুল করে দুটো গুলিয়ে না ফেলে বা ট্রেডমার্ক-সংক্রান্ত কোনো সমস্যা না হয়। চাইলে বদলাতে পারেন — নাম বদলাতে হলে `app.json`-এর `name`/`slug`/`scheme` এবং `android.package`/`ios.bundleIdentifier` (এই তিনটা জায়গায় একসাথে) বদলাতে হবে, Play Console/App Store Connect-এ রেজিস্ট্রেশনের আগে।
