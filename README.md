...
- ✅ **সব থার্ড-পার্টি লাইব্রেরি permissive লাইসেন্সের (মূলত MIT)** — বিস্তারিত `THIRD_PARTY_LICENSES.md`-এ। কোনো GPL-জাতীয় copyleft লাইব্রেরি ব্যবহার করা হয়নি, তাই সোর্স কোড পাবলিশ করার বাধ্যবাধকতা নেই।
